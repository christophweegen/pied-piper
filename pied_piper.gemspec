...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Unix-like pipes in Ruby}
  spec.description   = %q{Unix-like pipes in Ruby}
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata["changelog_uri"] = "https://github.com/christophweegen/pied-piper/CHANGELOG.md"
  else
